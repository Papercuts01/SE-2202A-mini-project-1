...
function Assignment(title, dueDate) {
    ...
    //print function that outputs the assignment
...
function Course(courseName, instructor, creditHours, assignments) {
    ...
    //print function that outputs all the course info
    this.courseInfo = function () { 
        ...
        //deploys the printAssignment() function from the Assignment class
